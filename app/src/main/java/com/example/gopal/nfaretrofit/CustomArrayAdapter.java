...
/**
 * Created by Gopal on 7/6/2019.
 */


public class CustomArrayAdapter extends ArrayAdapter<Movie> {
    private String mPublishedDate;
    public CustomArrayAdapter(Context context, ArrayList<Movie> news){
